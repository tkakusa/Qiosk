...
import fragment.JobListFragment;
...
import com.example.haileyhultquist.qiosk.SignInActivity;
...
public class NavigationActivity extends AppCompatActivity {
    ...
    private static final String TAG_JOBLIST = "job list";
    private static final String TAG_PROFILE = "profile";
    public static String CURRENT_TAG = TAG_JOBLIST;

    // arguments being brought in
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_create:
                        if (userType.equals("employer")) {
                            ...
                            navItemIndex = 0;
                            CURRENT_TAG = TAG_JOBLIST;
                            Toast.makeText(NavigationActivity.this, "ONLY EMPLOYERS CAN CREATE JOBS", Toast.LENGTH_LONG).show();
                            break;
                        }
